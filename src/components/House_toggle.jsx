...
import "./House_toggle.css";

function HouseToggle({ ifclick }) {
  return (
    <div className="house-toggle">
      <div className="house-info">
        <div className="house-title">
          <p style={{ fontWeight: "bold" }}>Unit Detials</p>
          <img src={cancel} className="image-cancel" onClick={ifclick} />
        </div>
          ...
          <div className="content-left">
            ...
            <div className="content-down">
              <div style={{ display: "flex" }}>
                <img src={handbook} style={{ height: "20px", width: "20px" }} />
                <p style={{ fontWeight: "bold", color: "#696a6b" }}>Handbook</p>
              </div>
